...
<h1 class="page-title" id="form-page-title"><?= $page_title ?></h1>

<?php if ($is_edit_mode): ?>
    <input type="hidden" id="edit-plan-id" value="<?= htmlspecialchars($plan_id) ?>">
<?php endif; ?>

<form id="createPlanForm" onsubmit="handlePlanSubmit(event)">
    ...
    <button type="button" class="btn btn-outline" style="width: 100%; margin-top: 15px; padding: 15px; border-style: dashed;" onclick="addTimeframe()">
