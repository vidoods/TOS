...
<div class="login-box fade-in">
        <div class="text-center mb-4">
            <h1 style="text-align: center; margin-bottom: 30px; font-size: 24px;">Reset Password</h3>
        ...
        <div class="mt-4 text-center">
            <a href="index.php?view=login" class="text-decoration-none text-white-50">Back to Login</a>
        </div>
</div>