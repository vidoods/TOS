<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4 responsive-header">
        <div>
            <h2 class="m-0" id="ad-name" style="font-weight: 700; font-size: 2rem; line-height: 1.2;">Loading...</h2>
            <div class="mt-2">
        ...
        <div class="d-flex gap-2">
            ...
            <button id="btn-add-trade-account" class="btn btn-primary">
                <i class="fas fa-plus me-2"></i> Trade
            </button>
        </div>
    </div>
    ...
    <div id="tab-overview" class="tab-content active">
        ...
        <div class="glass-panel mb-4" style="padding: 30px;">
            <div class="d-flex justify-content-between align-items-end mb-3">
                <div>
                    <div class="text-secondary text-uppercase" style="font-size: 0.85rem; font-weight: 600; margin-bottom: 5px;">Current balance</div>
...
<div id="payout-modal" class="modal" style="display: none;">
    <div class="modal-content glass-panel" style="max-width: 500px; width: 100%;">
        ...
        <h2 id="payout-modal-title" class="text-center mb-4">Add payout</h2>
        ...
        <form id="payout-form">
            ...
            <button type="submit" class="btn btn-primary w-100 mt-3" style="padding: 12px; font-size: 1rem;">Save</button>
        </form>
    </div>
</div>