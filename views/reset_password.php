...
$token = $_GET['token'] ?? '';
if (!$token) {
    die('<div class="text-white text-center mt-5">Invalid token. <a href="index.php">Go Home</a></div>');
}
?>
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="glass-panel p-5" style="max-width: 400px; width: 100%;">
        ...
        <form id="reset-form">
            ...
            <div class="mb-4">
                <label class="form-label text-white-50">Enter New Password</label>
                <input type="password" class="form-control bg-dark text-white border-secondary" id="reset-password" required minlength="6">
            </div>
            <button type="submit" class="btn btn-success w-100 py-2">Change Password</button>
        </form>
    </div>
</div>